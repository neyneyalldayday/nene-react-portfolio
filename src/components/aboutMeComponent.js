          ...
          <ColumnLeft>
            ...
            >
              ...
              <p>
                ...
                popular frameworks like React and libraries like Redux. On the
                front-end, I'm proficient in developing mobile applications
                ...
                enhanced user experiences. In the back-end realm, I'm
                ...
                sending functionality. When it comes to databases, I have
                ...
                capabilities. For testing purposes, I'm well-versed in using
                ...
                debugging and optimizing applications. Beyond the core
                development skills, I have knowledge of microservice
                ...
                for hosting static websites. In addition to my technical skills,
                I have a strong creative side. I have soft skills in Adobe
                ...
                the computer screen. Overall, I am a dedicated and versatile
              ...
              <p>
                Client: HTML, CSS, JavaScript, React, Redux, React Native,
                Material UI, Bootstrap, Materialize, Styled-Components, SCSS,
                Handlebars, jQuery Server: NodeJS, Express, Next.js, Webpack,
                Gatsby/NextJS Serverless Functions, GraphQL, Apollo, JSON Web
                Tokens, Socket.io, Nodemailer DataBase/ORM: MongoDB, MySQL,
                Firebase, Mongoose, Sequelize Testing: Jest, Chai, Mocha
                Environments: Windows 10, git Bash Linux Command Line Other:
                Microservice Architecture, AWS S3, Git, GitHub Pages, Heroku,
                Vercel, Chrome Developer Tools, React Developer Tools
              </p>
            </Content>
          </ColumnLeft>
          <ColumnRight>
